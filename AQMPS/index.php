                  ...
                  <div class="col-md-10 home-p pt-2 rounded shadow">
                      <p class="p-font f-inc">
                        <h4>What is Air Quality Monitoring and Prediction System?</h4>
                          <p style ="margin-left : 25px"> Air Quality Monitoring and Prediction System is to ease the process for the government to keep a close watch on the industries pollution levels.It also makes it easy for industries to measure their own pollution levels and try to control the same.</p>

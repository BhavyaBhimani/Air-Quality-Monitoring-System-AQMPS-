        ...
        <div class="col-6">
            ...
            <div class="specific-bg pb-1 pt-3 rounded mb-4 px-3" style="">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea type="text" class="form-control f-inc" name="comments" placeholder="<?php echo $rows10['Comments']; ?>" rows="4" cols = "74" ></textarea>
                </div>
				 <div class="m-auto">
				  ...
				  <?php
						...
						<input type='submit' class='btn btn-warning btn-block btn-font' value='Submit' style='width:110px; position : relative ; left:200px;'>";
              ...
              <div class="container-fluid bg-white rounded border border-3 shadow rounded">
                  ...
                  <div class="mb-3" style="height: 400px;">     
                    <div class="img-fluid text-center">
                      <?php echo "<img src='".$rows10['Password'].".jpg' style='width:550px;'></img>"; ?>
                    </div>
                  </div>
              </div>
          </div>
        ...
        <div class="col-6">
          <div class="">
              ...
              <div class="container-fluid bg-white rounded border border-3 shadow rounded">
                  ...
                  <div class="mb-3" style="height: 400px;">     
                    <div class="img-fluid text-center">
                      <?php echo "<img src='".$rows10['Password']."_predict.jpg' style='width:550px;'></img>"; ?>
                    </div>
                  </div>
              </div>
          </div>

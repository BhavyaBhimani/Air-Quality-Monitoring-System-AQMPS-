    ...
    <div class="dropdown container-fluid">
        ...
        <?php 
					...
					while($rows1= mysqli_fetch_array($result1))
					{
						...
						$idens = $rows1['Id'];
						echo "<a class='dropdown-item' href='Specific_Industryg.php?Id=".$idens."&user=".$usename."'> ".$indus."</a>";
					}
            ...
            <div class="specific-bg pb-1 pt-3 rounded mb-4 px-3" style="">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
				 ...
				 <div class="m-auto">
				 <br>	
				 <?php echo "<a href='Specific_Industryg1.php?Id=".$ids."&user=".$name."'>"; ?><img src='img/edit.jpg' role='' alt='edit' class='ml-1' style="width: 100px; height: 50px;"></a>
				 </div>
              </div>
            </form>
            </div>

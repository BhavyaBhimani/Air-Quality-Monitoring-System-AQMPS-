    ...
    <div class=" py-3 header-bg">
      ...
      <div class="container">
          <ul class="nav nav-tabs justify-content-center">
            <li class="nav-item">
              <a class="nav-link white-txt n-font nav-font" href="#">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link white-txt n-font nav-font" href="#">About</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-success  bg-light nav-font n-font disabled" aria-current="page" href="#">Dashboard</a>
            </li>
            <li class="nav-item">
              <a class="nav-link white-txt n-font nav-font" href="#">License</a>
            </li>
            <li class="nav-item">
                <a class="nav-link white-txt n-font nav-font" href="#">Payment</a>
            </li>
            <li class="nav-item">
                <a class="nav-link white-txt n-font nav-font" href="#">Logout</a>
            </li>
            </ul>
      </div>
  </div>
        ...
        <div class="col-6">
            ...
            <div class="specific-bg pb-1 pt-3 rounded mb-4 px-3" style="">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control text-dark f-inc" name="scale" placeholder= "<?php echo $rows10['Scale']; ?>" readonly disabled>
                </div>
              </div>
              <div class="form-group row">
                <label for="rating" class="col-sm-2 col-form-label text-white n-font f-inc">Rating</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control f-inc" name="rating" placeholder="<?php echo $rows10['Rating']; ?> %" readonly disabled>
                </div>
              </div>
              <div class="form-group row">
                <label for="comments" class="col-sm-2 col-form-label text-white n-font f-inc">Comments</label>
				<form method = 'POST' action = 'Comments_update.php'>
                <div class="col-sm-10">
                  <textarea type="text" class="form-control f-inc" name="comments" placeholder="" rows="4" ></textarea>
                </div>
				 <div class="m-auto">
				  <!-- <button type='submit' class='btn btn-warning justify-content-center btn-font mt-3'>Update</a><img src='img/edit-1.png' role='button' alt='edit' class='ml-1' style="width: 20px; height: 20px;"></button> -->
				  <?php
			  
						
						echo "<input type='hidden' name='username' value=".$name."/>";
						echo "<input type='hidden' name='identity' value=".$ids."/>
